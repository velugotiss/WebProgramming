...
var BookDetailComponent = /** @class */ (function () {
    function BookDetailComponent(route, api, router, _snackBar) {
        this.route = route;
        this.api = api;
        this.router = router;
    ...
    BookDetailComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"], _api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_2__["MatSnackBar"]])
    ], BookDetailComponent);
...
var BookEditComponent = /** @class */ (function () {
    ...
    BookEditComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            ...
            _this.api.getBook(_this.bookId).subscribe(function (data) {
    ...
    BookEditComponent.prototype.onUpdateBook = function (form) {
        var _this = this;
        this.api.updateBook(this.bookId, form)
            .subscribe(function (res) {
            var id = res['_id'];
            _this.router.navigate(['/book-details', id], { queryParams: { updated: true } });
        }, function (err) {
            console.log(err);
        });
    };
...
var BookComponent = /** @class */ (function () {
    function BookComponent(api, router, _snackBar) {
        this.api = api;
        this.router = router;
        this._snackBar = _snackBar;
        this.displayedColumns = ['isbn', 'title', 'author', 'edit', 'delete'];
    ...
    BookComponent.prototype.deleteBook = function (event, element) {
        var _this = this;
        event.stopPropagation();
        this.api.deleteBook(element._id).subscribe(function (res) {
            _this.getBooks();
            _this._snackBar.open('Deleted successfully', "Deleted", {
                duration: 5000,
                horizontalPosition: "right",
                verticalPosition: "top",
            });
    ...
    BookComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_3__["MatSnackBar"]])
    ], BookComponent);
...
module.exports = __webpack_require__(/*! C:\Fall 2020\Web\ICP7\Source\src\main.ts */"./src/main.ts");
