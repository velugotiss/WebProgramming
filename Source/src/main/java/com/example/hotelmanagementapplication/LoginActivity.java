...
public class LoginActivity extends AppCompatActivity {
    ...
    public static String LoggedInUser1Name="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            guestOrStaff = extras.getString("logging in guest/staff");
        }
    ...
    public void attemptLogin(View v) {
        ...
        LoggedInUser1Name = email;

        if(guestOrStaff.equalsIgnoreCase("staff"))
        {
                    ...
                    .addOnCompleteListener(LoginActivity.this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (!task.isSuccessful()) {
                                ...
                                Intent intent = new Intent(LoginActivity.this, HotelStaffPage.class);
                    ...
                    .addOnCompleteListener(LoginActivity.this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (!task.isSuccessful()) {
                                ...
                                Intent intent = new Intent(LoginActivity.this, WelcomeGuest.class);
                                intent.putExtra("email", email);
                                intent.putExtra("pass", password);
                                startActivity(intent);
                                finish();
